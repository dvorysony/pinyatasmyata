...
const INITIAL_PRODUCTS = [
    { id: "new-1", name: "Пиньята-цифра",        desc: "Пиньята в виде цифры или буквы. Идеально для дня рождения.", price: "от 5 000 ₽",    image: "images/cifra.jpg",  button: "Написать" },
...
server.listen(PORT, function () {
    ...
    console.log('  (сменить: set ADMIN_PASSWORD=новый && node server.js)');
    console.log('');
});